...
struct node; // forward declaration: dichiaro che usero' una struct, ma non voglio far vedere come e' fatta dentro; la implementero' nel file listaASD-dll_aux.cpp; e' macchinoso ma e' il meglio di information hiding che possiamo ottenere in C++: i linguaggi a oggetti nascono per superare queste "macchinosita'"! 
